	...
	, m_selFileEdit( H_AlignLeft | V_AlignTop | ui::V_TileMate )
{
	...
	//	This is just a demo (and anti-pattern) of using icons with non-standard sizes as icon array.
	//	Use PNG image arrays instead.
	//
	VERIFY( m_selFileEdit.GetMateToolbar()->GetStrip()._LoadIconStrip( IDI_MY_TOOL_STRIP_ALPHA_ICON, ARRAY_SPAN( s_buttonIds ) ) );		// IDI_MY_TOOL_STRIP_ICON
}
