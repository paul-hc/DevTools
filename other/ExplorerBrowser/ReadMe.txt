...
ExplorerBrowser.h
    ...
    CExplorerBrowserApp application class.

ExplorerBrowser.cpp
    This is the main application source file that contains the application
    class CExplorerBrowserApp.
...
ExplorerBrowserDoc.h, ExplorerBrowserDoc.cpp - the document
    These files contain your CExplorerBrowserDoc class.  Edit these files to
    add your special document data and to implement file saving and loading
    (via CExplorerBrowserDoc::Serialize).

ExplorerBrowserView.h, ExplorerBrowserView.cpp - the view of the document
    These files contain your CExplorerBrowserView class.
    CExplorerBrowserView objects are used to view CExplorerBrowserDoc objects.

res\ExplorerBrowserDoc.ico
    This is an icon file, which is used as the icon for MDI child windows
    for the CExplorerBrowserDoc class.  This icon is included by the main
