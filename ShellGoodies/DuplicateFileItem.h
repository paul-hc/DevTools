...
public:
	...
	void ExtractCrc32Duplicates( std::vector< CDuplicateFilesGroup* >& rDuplicateGroups, size_t& rIgnoredCount, ui::IProgressService* pProgress = NULL ) throws_( CUserAbortedException );
	void __ExtractCrc32Duplicates( std::vector< CDuplicateFilesGroup* >& rDuplicateGroups, size_t& rIgnoredCount, ui::IProgressService* pProgress = NULL ) throws_( CUserAbortedException );	// old version using group stores
...
public:
	...
	void ExtractDuplicateGroups( std::vector< CDuplicateFilesGroup* >& rDuplicateGroups, size_t& rIgnoredCount, ui::IProgressService* pProgress = NULL ) throws_( CUserAbortedException );
private:
